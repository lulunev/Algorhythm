...
class PlaylistMasterViewController: UIViewController {
    ...
    private struct Indentifiers {
        static let showPlaylistDetailSegue = "showPlaylistDetailSegue"
    }
    
    
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == Indentifiers.showPlaylistDetailSegue {
    ...
    @IBAction func showPlaylistDetail(sender: AnyObject) {
        ...
        performSegueWithIdentifier(Indentifiers.showPlaylistDetailSegue, sender: sender)
